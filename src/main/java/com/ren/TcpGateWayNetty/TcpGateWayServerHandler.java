    ...
    protected void channelRead0(ChannelHandlerContext channelHandlerContext, String s) throws Exception {
        ...
        if (s != null) {
            ...
            for (int i = 0; i < arrMsg.length; i++) {
                ...
                industrialMessageForTcp.setE(result[16]);
                industrialMessageForTcp.setF(result[18]);
                industrialMessageForTcp.setG(result[20]);
                industrialMessageForTcp.setH(result[22]);
